...
function main::clean(){
    [[ ! -d ${VENV_FOLDER} ]] && return 0 # no tenemos directorio para eliminar
    rm -fR ${VENV_FOLDER} # remove virtual enviroment
    return 0 # disable el clean de archivos, directorios y temporales
